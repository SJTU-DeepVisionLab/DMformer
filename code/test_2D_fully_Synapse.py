...
def test_single_volume(case, net, test_save_path, FLAGS):
    h5f = h5py.File(FLAGS.root_path + "/data/test_vol_h5/{}.npy.h5".format(case), 'r')
    image = h5f['image'][:]
    label = h5f['label'][:]
...
def Inference(FLAGS):
    ...
    for case in tqdm(image_list):
        first_metric, second_metric, third_metric, forth_metric, fifth_metric, sixth_metric, seventh_metric, eighth_metric  = test_single_volume(
    ...
    avg_metric = [first_total / len(image_list), second_total /
                  ...
                  forth_total / len(image_list), fifth_total / len(image_list), 
                  sixth_total / len(image_list), seventh_total / len(image_list),
                  eighth_total / len(image_list)]
    return avg_metric
