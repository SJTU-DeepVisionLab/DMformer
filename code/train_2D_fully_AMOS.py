...
parser.add_argument('--exp', type=str,
                    default='AbdomenMR/DMformer', help='experiment_name')
...
parser.add_argument('--adjustment_rate_intra', type=float,
                    default=0.0001, help='adjustment_rate')
...
def patients_to_slices(dataset, patiens_num):
    ...
    elif "AbdomenMR" in dataset:
        ref_dict = {"2": 27, "4": 53, "5": 1263,
                    "15": 2526, "23": 3967, "27": 5135, "60": 12631}
    else:
        print("Error")
...
def train(args, snapshot_path):
    ...
    current_average_confidence_intra = 0.25*np.ones(args.num_classes)
    ...
    current_average_confidence_inter = 0.07*np.ones(args.num_classes)
    average_confidence_inter = 0.07 * np.ones(args.num_classes) 
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            optimizer.pc_backward(unsup_loss) 
